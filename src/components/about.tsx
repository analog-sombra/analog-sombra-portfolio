    ...
    <div className="col-span-7 border-2 rounded-xl border-[#72906E] p-4 w-6xl mx-auto">
      ...
      <div className="mt-4">
        ...
        <p className="text-[#373529] text-xl font-medium mb-3">
          ...
          <span className="bg-[#f3dcb4]">Karan</span>, I am from India. For some
          reason I am Lazy as a developer but I love coding and building things.
        </p>
        ...
        <p className="text-[#373529] text-lg font-medium mb-2">
          - I Alwyas like to see the sky that is filled with stars and a moon i
          know it&apos;s cold but it&apos;s give me charminga and warm feeling
        </p>
        <p className="text-[#373529] text-lg font-medium mb-2">
        ...
        <p className="text-[#373529] text-lg font-medium">
          I wish to learn Game dev, I started learnig it but due to some reasons
          I left it. Maybe in future I will get back to it who knows.
        </p>
      </div>
    </div>
  );
